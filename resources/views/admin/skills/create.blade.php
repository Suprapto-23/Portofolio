...
<div class="max-w-3xl mx-auto space-y-8">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-black text-blue-950">Tambah Skill</h1>
            <p class="text-sm text-slate-500 font-medium mt-1">Tambahkan teknologi baru ke daftar keahlian.</p>
        </div>
    </div>
