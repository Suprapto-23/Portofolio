...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-black text-blue-950">Tambah Pengalaman</h1>
            <p class="text-sm text-slate-500 font-medium mt-1">Isi detail pekerjaan atau organisasi baru.</p>
        </div>
    </div>

    <form action="{{ route('admin.experiences.store') }}" method="POST" class="bg-white rounded-3xl border border-slate-200/70 shadow-sm p-6 sm:p-8">
        @csrf
